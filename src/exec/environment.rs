...
pub struct Environment {
    ...
    /// Directory stack for pushd/popd. Index 0 is always the current directory.
...
impl Environment {
    ...
    pub fn new() -> Self {
        ...
        let mut env = Environment {
            ...
            random_state: pid ^ dynamic_vars::epoch_secs_now() as u32,
            start_epoch_secs: dynamic_vars::epoch_secs_now(),
            seconds_offset: 0,
            lineno: 0,
            lineno_offset: 0,
            getopts_subindex: 0,
    ...
    // Dynamic variable dispatch is in environment/dynamic_vars.rs.

    // Directory stack methods are in environment/dir_stack.rs.
    ...
    pub fn from_serialized(s: SerializedEnvironment) -> Self {
        Environment {
            ...
            random_state: std::process::id() ^ dynamic_vars::epoch_secs_now() as u32,
            start_epoch_secs: dynamic_vars::epoch_secs_now(),
            seconds_offset: 0,
            lineno: 0,
            lineno_offset: 0,
...
#[path = "environment/dir_stack.rs"]
mod dir_stack;
#[path = "environment/dynamic_vars.rs"]
mod dynamic_vars;
